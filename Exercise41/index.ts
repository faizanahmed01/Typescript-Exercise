...
function carinformation(manufacturer:string , model:string, ...properties:[string , any][]): any
{
    const car : any = {
        manufacturer,
        model,
...
const myCar:string = carinformation("Honda","Civic",["Color","red"] ,["speed","300 km/hr"]);
